...
ejecutable = "C:\Mac\Home\Desktop\Proyecto_visual_RAWSim_O\Proyecto_visual_RAWSim_O\RAWSimO.CLI\bin\Debug\net6.0\RAWSimO.CLI.exe ";
...
% xconf file for the Stage 1, Set 2  (TO DO)
% xconf = ["",...
%          ""];
...
A = string([11]); % An example with a single instance

carpetasLen = xsettlen*xinstLen;
for i = 1: length(A) % This sweeps the given set 
        carpetas(i)= append('Set_1_',A(i),' '); %change for the name of your experiment folder 
        carpetassinespacio(i)= append('Set_1_',A(i)); %change for the name of your experiment folder
end
...
fID = fopen('BatchFile_Main_Stage_Set_1_inst11_seed1_2_3_7_24h.bat','w') 
fprintf(fID, '%s\n \n', linea1)
fprintf(fID, '%s\n', names)
fclose(fID)
...
fID2 = fopen('ProcessData_BatchFile_Main_Stage_Set_1_inst11_seed1_2_3_7_24h.bat','w'); 
fprintf(fID2, '%s\n \n', linea1);

iniciocopy = "copy C:\Users\MARIA\OneDrive\Desktop\Test_rawsimO\"; % Path to your Desktop experiments folder
carpetadepaste = "C:\Users\MARIA\OneDrive\Desktop\Test_rawsimO\Set_1_statistics" % Path to a new folder for pasting the renamed statistics files 
inicioren = "REN C:\Users\MARIA\OneDrive\Desktop\Test_rawsimO\Set_1_statistics\statistics.txt";% Change for the same path as in the previous line, but do not change the \statistics.txt part
